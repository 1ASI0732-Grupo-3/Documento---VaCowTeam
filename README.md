...
<p align="center">
  ...
  <span style="font-size: 2em;"><em><strong>TB2</strong></em></span>
</p>
...
Para mantener la legibilidad del código se preparo un `.editoconfig`. Esto con el fin de mantener las reglas en el formato del código (variables, métodos, atributos, etc.).
